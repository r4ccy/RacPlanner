...
fun BuscadorCarrera(
    ...
    val carrerasFiltradas = state.carreras.filter { carrera ->
        carrera.nombre.contains(busqueda, ignoreCase = true) ||
                carrera.codigo.contains(busqueda, ignoreCase = true)
    }
    ...
    Column(
        ...
        Text(
            text = "${carrerasFiltradas.size} resultados",
        ...
        when {
            ...
            state.carreras.isEmpty() -> {Text("No hay carreras disponibles")}
                ...
                LazyColumn (
                    ...
                    items(carrerasFiltradas) { carrera ->
                        Card(
                            modifier = Modifier.fillMaxWidth(),
